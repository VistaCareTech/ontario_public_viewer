...
const pending_projects = L.esri.featureLayer({
    url: "https://services3.arcgis.com/gEE42E4cRBu8xbBM/ArcGIS/rest/services/Pending_Projects_PROD/FeatureServer/0",
    useCors: true,
...
var provincial_federal_funded = L.esri.featureLayer({
    url: "https://services3.arcgis.com/gEE42E4cRBu8xbBM/arcgis/rest/services/Provincially_and_Federally_Funded_Projects_PROD/FeatureServer/0",
    useCors: true,
    style: function (feature) {
        let c;
        switch (feature.properties.Project_Status_EN) {
...
var Provincial_funded = L.esri.featureLayer({
    url: "https://services3.arcgis.com/gEE42E4cRBu8xbBM/ArcGIS/rest/services/Provincially_Funded_Projects_PROD/FeatureServer/0",
    useCors: true,
    style: function (feature) {
        let c;
        switch (feature.properties.Project_Status_EN) {
